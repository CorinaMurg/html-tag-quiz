...
export const tagsDataWithDetails = `{
    "<!--...>", "Defines a comment", FALSE, "", FALSE,
    ...
    "<div>", "Defines a section in a document", FALSE, "It's a generic block-level container that has no special meaning. It should only be used when no other semantic elements are relevant", FALSE,
    ...
    "<span>", "Defines a section in a document", FALSE, "It's a generic inline-level container that has no special meaning. It should only be employed when no other semantic elements are relevant.", FALSE,
